...
def authentication_widget():
    ...
    with st.session_state["authentication_container"]:
        ...
        authenticate(st.session_state['openai_api_key'], st.session_state['activeloop_token'], st.session_state['activeloop_token'] )
        with st.expander(
...
def select_data_source_widget():
    ...
    with st.session_state["data_source_container"], st.expander("Data Source"):
        ...
        st.session_state["vector_store"] = st.session_state['default_vectore_store']
        st.session_state["data_source"] = st.session_state['default_vectore_store']
        update_chain()
